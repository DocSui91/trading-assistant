...
st.caption("Version 2.8 • Depot-Einstand + P/L + Nachkauf-Simulator + Signalbeobachtung")
...
with stocks:
    ...
    c4,c5=st.columns(2)
    with c4:
        quantity=st.number_input("Stückzahl (bei Depot)",min_value=0.0,value=0.0,step=1.0)
    with c5:
        avg_entry=st.number_input("Ø Einstandskurs (bei Depot)",min_value=0.0,value=0.0,step=1.0)
...
st.divider()
st.caption("Trading Assistant • Version 2.8")
