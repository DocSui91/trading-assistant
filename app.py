...
st.caption("Version 2.3.1 • Original-News auf Englisch + deutsche KI-Ergänzung + Kostenbremse")
...
tabs=st.tabs(["📊 Dashboard","📈 Aktien","⚡ Turbos","📰 News","🔎 Analyse","🔥 Hype Radar","💶 KI-Kosten"])
dashboard,stocks,turbos,news_tab,analysis,radar,costs=tabs
...
st.divider()
st.caption("Trading Assistant • Version 2.3.1")
